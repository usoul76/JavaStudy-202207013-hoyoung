...
public class StudentService {
	...
	private void printSelectErrirMessage() {
	...
	private boolean showStudentSearch() {
		...
		if(select.equals("1")) {
			...
			System.out.println("이전 매뉴로 돌아갑니다");
			return false;
		}else {
			printSelectErrirMessage();
		}
	...
	private void showSearchStudent() {
		...
		Student serStudent = searchStudentByStudentName(searchName);
		if(serStudent != null) {
			System.out.println(serStudent.toString());
		}
